...
#SBATCH --job-name=agentclinic-nejm-ext
#SBATCH --output=/scratch/%u/agentclinic/logs/%x-%j.out
#SBATCH --error=/scratch/%u/agentclinic/logs/%x-%j.err

# ─────────────────────────────────────────────────────────────────────────────
# AgentClinic — NEJM_Extended dataset, all-Voyager (text-only, no images)
#
# Note: NEJM_Ext does NOT pass images to the doctor (only base NEJM does).
# The current voyager text models are sufficient for this dataset.
#
...
#
# Submit:   sbatch sol_slurm_nejm_ext.sh
# ─────────────────────────────────────────────────────────────────────────────
...
DOCTOR_BIAS="None"
PATIENT_BIAS="None"
OUTPUT_DIR="$AC_DIR/trajectories/voyager/nejm_ext"
# ─────────────────────────────────────────────────────────────────────────────

# ── Use third API key to avoid rate-limit collisions with other jobs ──────────
VOYAGER_API_BASE=https://openai.rc.asu.edu/v1
VOYAGER_API_KEY=sk-f9qul6qF7O7-CvFHfjkppg
# ─────────────────────────────────────────────────────────────────────────────
...
echo "============================================"
echo "  AGENTCLINIC — NEJM_EXT VOYAGER RUN"
echo "============================================"
