...
#SBATCH --job-name=agentclinic-qwen72b-nejm-ext
...
# Dataset: NEJM_Ext (text-only, no images)
#
...
#
# Submit:  sbatch sol_slurm_qwen72b_nejm_ext.sh
# ─────────────────────────────────────────────────────────────────────────────
...
DOCTOR_BIAS="None"
PATIENT_BIAS="None"
OUTPUT_DIR="$AC_DIR/trajectories/qwen72b/nejm_ext"
# ─────────────────────────────────────────────────────────────────────────────
